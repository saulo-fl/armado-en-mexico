     ...
     <div style={containerMax}>
      ...
      <div style={{
        ...
        <div style={{
            ...
            fontFamily: 'Courier Prime, monospace',
            fontSize: 8, color: PALETTE.textMuted,
          ...
          <div style={{
            ...
            <div style={{
              ...
              <span style={{
                ...
                fontFamily: 'Courier Prime, monospace',
                fontSize: vp.isDesktop ? 13 : 10, fontWeight: 700, color: ORANGE
              }}>{fallbackIcon || '◆'}</span>
            </div>
            {/* texto */}
            <div style={{ minWidth: 0, flex: 1 }}>
              <div style={{
                fontFamily: 'Courier Prime, monospace',
                fontSize: vp.isDesktop ? 8.5 : 7.5, color: '#A3A3A3',
                textTransform: 'uppercase', letterSpacing: '0.16em',
                marginBottom: 1
              }}>{label}</div>
              <div style={{
                fontFamily: 'Montserrat, sans-serif',
                fontWeight: 600, fontSize: vp.isDesktop ? 13 : 10.5,
                color: '#FFFFFF',
          ...
          return (
            ...
            <div style={{
              ...
              <div style={{ textAlign: 'right', flexShrink: 0 }}>
                ...
                <div style={{ display: 'flex', justifyContent: 'flex-end', alignItems: 'center', gap: 8 }}>
                  ...
                  <div style={{
                      fontFamily: 'Montserrat, sans-serif',
                      fontWeight: 700, fontSize: vp.isDesktop ? 22 : 16,
                      color: ORANGE,
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <div style={{
                    ...
                    fontFamily: 'Courier Prime, monospace',
                    fontSize: vp.isDesktop ? 11 : 9, color: '#A3A3A3',
                    letterSpacing: '0.18em', textTransform: 'uppercase',
                    textAlign: 'center'
                  }}>
                      <div style={{ color: ORANGE }}>[ ▢ PNG SIN FONDO ]</div>
                      <div style={{ fontSize: 9, opacity: 0.7, marginTop: 4 }}>{arma.nombre}</div>
                    </div>
                  }
                </div>
            ...
            <div style={{
              ...
              <div style={{
                  padding: '10px 12px',
                  fontFamily: 'Courier Prime, monospace',
                  fontSize: 9, color: '#A3A3A3', lineHeight: 1.55,
          ...
          <div>
            ...
            <div style={{
              ...
              <div style={{
                ...
                fontSize: 22, color: PALETTE.amber,
              ...
              <div style={{
                ...
                marginTop: 6
              }}>Nivel: <span style={{ color: PALETTE.amber }}>{window.starsCost(arma.priceLvl)}</span></div>
            </div>
                    ...
                    <div key={i} style={{
                      ...
                      background: i === 0 ? 'rgba(245,197,24,0.06)' : 'transparent'
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                          ...
                          {h.note && <span style={{ color: PALETTE.textMuted, fontSize: 9 }}>· {h.note}</span>}
                        </div>
      ...
      {related.length > 0 &&
        <div style={{ padding: `0 ${PAD}px 16px` }}>
          ...
          <div style={{
            ...
            {related.map((a) =>
            <div key={a.id} style={{ width: vp.isDesktop ? 'auto' : 150, flexShrink: 0 }}>
                <ArmaCard arma={a}
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
          <div style={{
            ...
            <span style={{ fontSize: 14, color: PALETTE.textMuted }}>/5</span>
          </div>
          <div style={{ flex: 1 }}>
    ...
    <div onClick={onClose} style={{
      ...
      <div onClick={(e) => e.stopPropagation()} style={{
        ...
        <div style={{
          ...
          <div>
            <div style={{ fontFamily: 'Courier Prime, monospace', fontSize: 9, color: PALETTE.amber, letterSpacing: '0.2em' }}>✎ SUGERIR CAMBIO</div>
            <div style={{ fontFamily: 'Montserrat, sans-serif', fontWeight: 700, fontSize: 16, color: PALETTE.text, textTransform: 'uppercase' }}>{arma.nombre}</div>
          </div>
        ...
        <div style={{ padding: 28, textAlign: 'center' }}>
            ...
            <div style={{ fontFamily: 'Montserrat, sans-serif', fontWeight: 700, fontSize: 18, color: PALETTE.text, textTransform: 'uppercase', marginBottom: 8 }}>¡Gracias!</div>
            <div style={{ fontFamily: 'Courier Prime, monospace', fontSize: 11, color: PALETTE.textDim, lineHeight: 1.6, marginBottom: 20 }}>Tu sugerencia entró en la cola. El curador revisará la información y, si procede, aplicará el cambio.</div>
            <button onClick={onClose} style={{
        ...
        <form onSubmit={submit} style={{ padding: 18 }}>
            ...
            fontFamily: 'Courier Prime, monospace', fontSize: 9, color: PALETTE.textMuted,
            lineHeight: 1.5
          }}>
  ...
  if (!a && !b) {
    return (
      <div style={{
        ...
        <div style={{ fontSize: 12, marginBottom: 8, color: PALETTE.text }}>COMPARADOR VACÍO</div>
        <div style={{ fontSize: 10, lineHeight: 1.6, marginBottom: 18 }}>
              ...
              <div key={stat.k} style={{
                ...
                alignItems: 'center', gap: 8, marginBottom: 10
                  ...
                  <div style={{ textAlign: 'right' }}>
                    <div style={{
                    fontFamily: 'Courier Prime, monospace',
                    fontSize: 11, color: winner === 'a' ? PALETTE.amber : PALETTE.text,
                    fontWeight: 700
                  }}>{va}</div>
                    <div style={{
                  ...
                  <div>
                    <div style={{
                    fontFamily: 'Courier Prime, monospace',
                    fontSize: 11, color: winner === 'b' ? PALETTE.amber : PALETTE.text,
                    fontWeight: 700
                  }}>{vb}</div>
                    <div style={{
                    height: 4, background: PALETTE.bg,
  ...
  if (!arma) {
    return (
      <button onClick={onPick} style={{
        ...
        <div style={{ fontSize: 9, color: PALETTE.textDim }}>Añadir arma</div>
      </button>);
    ...
    <div style={{
      ...
      <div style={{
        ...
        <button onClick={onRemove} style={{
          ...
          color: PALETTE.textMuted, fontSize: 11, padding: 0
        }}>✕</button>
      </div>
      <div style={{
        height: 90,
  ...
  return (
    <div style={{ padding: `20px ${padX}px 90px`, maxWidth: 700, margin: '0 auto', width: '100%', boxSizing: 'border-box' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
        ...
        <button key={it.id} onClick={() => onNav(it.id)} style={{
          ...
          display: 'flex', alignItems: 'center', gap: 14
            ...
            <span style={{ color: PALETTE.amber, fontSize: 16 }}>›</span>
          </button>
        )}
      </div>
      ...
      <div style={{
        ...
        <div style={{ color: PALETTE.amber, fontWeight: 700, letterSpacing: '0.15em', marginBottom: 4, fontSize: 9 }}>◆ ARMADO·MX</div>
  ...
  return (
    <form onSubmit={submit} style={{ padding: `0 ${padX}px 90px`, maxWidth: 880, margin: '0 auto' }}>
      ...
      <div style={{
        ...
        fontFamily: 'Courier Prime, monospace', fontSize: 10, color: PALETTE.textMuted,
        lineHeight: 1.6
      }}>
