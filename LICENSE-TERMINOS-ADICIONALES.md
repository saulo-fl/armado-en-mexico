...
## 1 · Origen y marcado de las versiones modificadas — AGPL-3.0 §7(c)

Queda prohibido tergiversar el origen de esta obra.

Toda versión modificada debe estar marcada de forma razonable como distinta de la
original. En concreto, debe:

- indicar de manera visible, en su interfaz y en su documentación, que es una obra
...
Esta licencia **no concede derecho alguno** sobre las marcas, nombres comerciales,
logotipos ni avisos comerciales del proyecto, entre ellos:
...
## Por qué estos dos términos no se pueden quitar

Ambos corresponden a los incisos **(c)** y **(e)** de la lista cerrada de la
sección 7 de la AGPL-3.0. Por tanto **no** constituyen «restricciones adicionales»
en el sentido de la sección 10, y un receptor posterior no puede eliminarlos al
redistribuir la obra.

## Qué **sí** puedes hacer

Todo lo que la AGPL-3.0 permite, y es casi todo: usar el proyecto para lo que
quieras, estudiarlo, modificarlo, redistribuirlo, publicarlo en tu propio servidor
e incluso cobrar por él. La única condición de fondo es que quien reciba tu versión
—incluso a través de una red— pueda recibir también su código fuente, bajo esta
misma licencia. Los dos términos de arriba solo impiden que tu versión se haga pasar
por la nuestra.
...
## 1 · Origin and marking of modified versions — AGPL-3.0 §7(c)

Misrepresenting the origin of this work is prohibited.

Every modified version must be marked in reasonable ways as different from the
original version. Specifically, it must:

- state visibly, in its user interface and in its documentation, that it is a
...
This license grants **no rights** in the trade names, trademarks, logos or service
marks of the project, including:
...
Both fall under items **(c)** and **(e)** of the closed list in section 7 of the
AGPL-3.0. They are therefore **not** "further restrictions" within the meaning of
section 10, and a downstream recipient may not remove them when redistributing.

## What you **may** do

Everything the AGPL-3.0 allows, which is nearly everything: use the project for any
purpose, study it, modify it, redistribute it, run it on your own server, and even
charge for it. The one substantive condition is that whoever receives your version
— including over a network — must also be able to receive its source code, under
this same license. The two terms above only prevent your version from passing
itself off as ours.
