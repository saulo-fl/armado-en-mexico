...
window.CALIBRES = [
  { id: '.22 LR',          clase: 'Rimfire',  uso: 'Práctica, plinking y caza menor',           velocidad: '~330 m/s', energia: '~150 J',  retroceso: 'Bajo',
    mm: 25.4, cartucho: 'imagenes/cartuchos/22lr.png', desc: 'El calibre de fuego anular más popular del mundo. Económico y de retroceso mínimo: ideal para iniciación, entrenamiento y control de plagas.' },
  { id: '.380 ACP',        clase: 'Pistola',  uso: 'Defensa personal compacta',                 velocidad: '~300 m/s', energia: '~280 J',  retroceso: 'Bajo-Medio',
    mm: 25, cartucho: 'imagenes/cartuchos/380acp.png', desc: 'Cartucho de defensa en pistolas subcompactas. De libre adquisición para civiles en México (DCAM), uno de los más solicitados para defensa de domicilio.' },
  { id: '.38 Special',     clase: 'Revólver', uso: 'Defensa y tiro recreativo',                 velocidad: '~260 m/s', energia: '~300 J',  retroceso: 'Medio',
    mm: 39.6, cartucho: 'imagenes/cartuchos/38special.png', desc: 'Cartucho de revólver clásico, fiable y noble. Estándar de defensa civil durante décadas; sigue vigente en revólveres de acero como el Taurus 856.' },
  { id: '.38 Super',       clase: 'Pistola',  uso: 'Tiro deportivo (IPSC) y defensa',           velocidad: '~430 m/s', energia: '~650 J',  retroceso: 'Medio',
    mm: 32.6, cartucho: 'imagenes/cartuchos/38super.png', desc: 'Muy arraigado en México. Alta velocidad y excelente para competencia de acción en plataformas tipo 1911 y Colt Government.' },
  { id: '9mm Parabellum',  clase: 'Pistola',  uso: 'Servicio, defensa y deportivo',             velocidad: '~360 m/s', energia: '~500 J',  retroceso: 'Medio',
    mm: 29.7, cartucho: 'imagenes/cartuchos/9mm.png', desc: 'El estándar mundial de pistola. Equilibrio entre capacidad, control y poder de parada. Restringido en México a corporaciones de seguridad.' },
  { id: '.40 S&W',         clase: 'Pistola',  uso: 'Servicio y seguridad',                      velocidad: '~330 m/s', energia: '~600 J',  retroceso: 'Medio-Alto',
    mm: 28.8, cartucho: 'imagenes/cartuchos/40sw.png', desc: 'Desarrollado para cuerpos policiales: más poder que el 9mm conservando capacidad razonable. Uso restringido a seguridad pública/privada.' },
  { id: '.243 Winchester', clase: 'Rifle',    uso: 'Caza menor-media y varmint',                velocidad: '~950 m/s', energia: '~3,200 J', retroceso: 'Medio',
    mm: 68.6, cartucho: 'imagenes/cartuchos/243win.png', desc: 'Versátil y de retroceso suave. Trayectoria tensa para caza de venado pequeño y tiro a media distancia.' },
  { id: '.270 Winchester', clase: 'Rifle',    uso: 'Caza media-mayor',                          velocidad: '~930 m/s', energia: '~3,800 J', retroceso: 'Medio-Alto',
    mm: 84.8, cartucho: 'imagenes/cartuchos/270win.png', desc: 'Clásico de cacería en campo abierto. Excelente alcance efectivo y energía para venado y borrego.' },
  { id: '.308 Winchester', clase: 'Rifle',    uso: 'Caza y tiro de precisión',                  velocidad: '~840 m/s', energia: '~3,500 J', retroceso: 'Alto',
    mm: 71.1, cartucho: 'imagenes/cartuchos/308win.png', desc: 'Uno de los calibres de rifle más equilibrados. Precisión sobresaliente y enorme disponibilidad de munición y rifles.' },
  { id: '.30-06 Sprg',     clase: 'Rifle',    uso: 'Caza mayor versátil',                       velocidad: '~880 m/s', energia: '~3,900 J', retroceso: 'Alto',
    mm: 84.8, cartucho: 'imagenes/cartuchos/3006.png', desc: 'Histórico y polivalente. Cubre prácticamente toda la caza norteamericana con amplia gama de balas.' },
  { id: '7mm Rem Mag',     clase: 'Rifle',    uso: 'Caza a larga distancia',                    velocidad: '~920 m/s', energia: '~4,500 J', retroceso: 'Alto',
    mm: 84.8, cartucho: 'imagenes/cartuchos/7mmrem.png', desc: 'Magnum de trayectoria muy tensa para tiros largos en campo abierto. Energía elevada con retroceso manejable para su clase.' },
  { id: '.300 Win Mag',    clase: 'Rifle',    uso: 'Caza mayor y larga distancia',              velocidad: '~900 m/s', energia: '~4,800 J', retroceso: 'Muy alto',
    mm: 84.8, cartucho: 'imagenes/cartuchos/300wm.png', desc: 'Magnum de gran potencia para piezas grandes y tiro extremo. Exige buen dominio por su retroceso pronunciado.' },
  { id: '6.5 PRC',         clase: 'Rifle',    uso: 'Precisión a larga distancia',               velocidad: '~915 m/s', energia: '~3,900 J', retroceso: 'Alto',
    mm: 73.7, cartucho: 'imagenes/cartuchos/65prc.png', desc: 'Cartucho moderno de altísimo coeficiente balístico. Favorito actual del tiro de precisión y la caza de montaña.' },
  { id: '12 GA',           clase: 'Escopeta', uso: 'Caza, defensa y tiro al plato',             velocidad: '~400 m/s', energia: 'Variable', retroceso: 'Alto',
    mm: 70, cartucho: 'imagenes/cartuchos/12ga.png', desc: 'El calibre de escopeta universal. Acepta perdigón, posta y bala; versátil para caza, deportivo (skeet/trap) y defensa.' },
  { id: '20 GA',           clase: 'Escopeta', uso: 'Caza menor y tiro',                         velocidad: '~380 m/s', energia: 'Variable', retroceso: 'Medio',
    mm: 70, cartucho: 'imagenes/cartuchos/20ga.png', desc: 'Más ligero que el calibre 12, con menor retroceso. Ideal para caza de ave y tiradores de menor complexión.' },
  { id: '.410 Bore',       clase: 'Escopeta', uso: 'Caza menor e iniciación',                   velocidad: '~360 m/s', energia: 'Variable', retroceso: 'Bajo',
    mm: 63.5, cartucho: 'imagenes/cartuchos/410.png', desc: 'El calibre de escopeta más pequeño. Retroceso muy suave: excelente para iniciación y control de plagas a corta distancia.' },
  { id: '5.56x45mm',       clase: 'Carabina', uso: 'Táctico y deportivo',                       velocidad: '~940 m/s', energia: '~1,700 J', retroceso: 'Bajo-Medio',
    mm: 57.4, cartucho: 'imagenes/cartuchos/556.png', desc: 'Estándar OTAN para fusil. Retroceso ligero y trayectoria tensa. Uso restringido en plataformas tipo AR a corporaciones/FF.AA.' },
  { id: '7.62x39mm',       clase: 'Carabina', uso: 'Táctico',                                   velocidad: '~715 m/s', energia: '~2,000 J', retroceso: 'Medio',
    mm: 56, cartucho: 'imagenes/cartuchos/762x39.png', desc: 'Cartucho intermedio robusto y fiable. Buen poder a distancias medias. Uso restringido a seguridad/FF.AA.' },
