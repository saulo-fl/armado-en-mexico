...
window.ACCESORIOS = [
  // ── cargadores ──
  amx(101, 'Cargador .22 LR · Nordic Components', 'Nordic Components', 'EUA', 'cargadores', 'dcam', 608.16,
  ...
  amx(102, 'Cargador .22 LR · Mossberg', 'Mossberg', 'EUA', 'cargadores', 'dcam', 304.08,
  ...
  amx(103, 'Cargador 5.56x45 · CZ 805', 'Česká Zbrojovka', 'Rep. Checa', 'cargadores', 'seguridad', 126.70,
  ...
  amx(105, 'Cargador .380 ACP · Grand Power', 'Grand Power', 'Eslovaquia', 'cargadores', 'dcam', 324.75,
  ...
  amx(106, 'Cargador · IWI Jericho', 'IWI', 'Israel', 'cargadores', 'dcam', 506.80,
    'CARGADOR PPISTOLA IWI M JERICHO II',
    ['Pistola IWI Jericho'],
    [['Plataforma', 'IWI Jericho']],
    'Cargador de repuesto para pistola IWI Jericho.'),
  amx(107, 'Cargador 9mm · IWI Masada', 'IWI', 'Israel', 'cargadores', 'dcam', 506.80,
  ...
  amx(108, 'Cargador 9mm · Springfield XD-M', 'Springfield Armory', 'EUA', 'cargadores', 'dcam', 506.80,
  ...
  amx(111, 'Cargador .22 LR · Tippmann (25)', 'Tippmann Arms', 'EUA', 'cargadores', 'dcam', 947.12,
  ...
  amx(116, 'Sistema C-MAG · HK G36', 'Beta Company', 'EUA', 'cargadores', 'ejercito', 8615.57,
  ...
  amx(117, 'Sistema C-MAG · Colt AR15 / M4 / M16', 'Beta Company', 'EUA', 'cargadores', 'seguridad', 6334.98,
  ...
  // ── opticas ──
  amx(201, 'Mira réflex · Meprolight MEPRO MOR', 'Meprolight', 'Israel', 'opticas', 'seguridad', 26606.91,
  ...
  amx(202, 'Mira réflex · Meprolight MEPRO GLS', 'Meprolight', 'Israel', 'opticas', 'seguridad', 22552.52,
  ...
  // ── empunaduras ──
  amx(301, 'Culata TSK · Beretta DT11', 'TSK', 'Italia', 'empunaduras', 'dcam', 5799.04,
  ...
  // ── refacciones ──
  amx(401, 'Cañón · escopeta de bomba Mod. 500', 'Mossberg', 'EUA', 'refacciones', 'dcam', 4611.86,
  ...
  amx(402, 'Clips luna · revólver Rhino .38', 'Chiappa', 'Italia', 'refacciones', 'dcam', 724.88,
  ...
  { ...amx(119, 'Cargador .22 LR · CZ P-09', 'Česká Zbrojovka', 'Rep. Checa', 'cargadores', 'dcam', 212.86,
  ...
  amx(120, 'Cargador 9mm · Glock 17 (17 cart.)', 'Glock', 'Austria', 'cargadores', 'dcam', 475.17,
  ...
  amx(121, 'Cargador 9mm · Glock 19 (17 cart.)', 'Glock', 'Austria', 'cargadores', 'dcam', 475.17,
  ...
  amx(122, 'Cargador .40 S&W · Glock 22 (16 cart.)', 'Glock', 'Austria', 'cargadores', 'dcam', 475.17,
  ...
  amx(123, 'Cargador 9mm · Beretta 92FS (15 cart.)', 'Beretta', 'Italia', 'cargadores', 'dcam', 578.51,
  ...
  amx(125, 'Cargador .22 LR · Browning 1911-22', 'Browning', 'Bélgica', 'cargadores', 'dcam', 633.50,
  ...
  amx(126, 'Cargador 12 GA · Optimum OPT VM G2 (10 cart.)', 'Optimum Arms', 'Turquía', 'cargadores', 'dcam', 993.32,
  ...
  amx(127, 'Cargador 20 GA · Optimum OPT VM G2 (10 cart.)', 'Optimum Arms', 'Turquía', 'cargadores', 'dcam', 993.32,
  ...
  { ...amx(130, "Cargador .22 LR · Browning Buck Mark (10 cart.)", "Browning", "Bélgica", 'cargadores', "dcam", 633.50,
  ...
  { ...amx(131, "Cargador .22 LR · CZ 457/512 (10 cart.)", "Ceska Zbrojovka", "Rep. Checa", 'cargadores', "dcam", 1140.30,
...
window.ACCESORIOS_PRICE_HISTORY = {
  101: [_h(OCT, 665.4, OCTd, 18), _h(JUL, 608.16, JULd, 8)],
  102: [_h(OCT, 332.7, OCTd, 46), _h(JUL, 304.08, JULd, 44)],
  103: [_h(OCT, 138.62, OCTd, 20), _h(JUL, 126.70, JULd, 20)],
  104: [_h(OCT, 841.81, OCTd, 39), _h(JUN, 1303.22, JUNd, 20), _h(JUN18, 761.73, JUN18d, 8), _h(JUL, 1304.78, JULd, 20)],
  105: [_h(OCT, 362.63, OCTd, 8), _h(JUL, 324.75, JULd, 6)],
  106: [_h(SEP, 555.08, SEPd, 18), _h(OCT, 554.5, OCTd, 5), _h(JUN18, 498.49, JUN18d, 10), _h(JUL, 506.80, JULd, 9)],
  107: [_h(SEP, 555.08, SEPd, 17), _h(OCT, 554.5, OCTd, 51), _h(JUN18, 498.49, JUN18d, 13), _h(JUL, 506.80, JULd, 22)],
  108: [_h(OCT, 554.5, OCTd, 37), _h(JUL, 506.80, JULd, 65)],
  109: [_h(OCT, 723.95, OCTd, 8), _h(JUL, 661.68, JULd, 1)],
  110: [_h(OCT, 621.04, OCTd, 5), _h(JUN18, 558.31, JUN18d, 6)],
  111: [_h(SEP, 1054.65, SEPd, 8), _h(OCT, 1053.55, OCTd, 40), _h(JUN18, 947.12, JUN18d, 4)],
  112: [_h(SEP, 701.44, SEPd, 5), _h(OCT, 693.12, OCTd, 42)],
  113: [_h(SEP, 666.1, SEPd, 35), _h(OCT, 543.41, OCTd, 70), _h(JUN, 488.85, JUNd, 1)],
  114: [_h(OCT, 368.86, OCTd, 36), _h(JUN, 368.86, JUNd, 36), _h(JUL, 368.86, JULd, 36)],
  115: [_h(OCT, 546.2, OCTd, 18), _h(JUN, 546.2, JUNd, 18), _h(JUL, 546.20, JULd, 18)],
  116: [_h(OCT, 9426.46, OCTd, 5), _h(JUN, 8479.99, JUNd, 5), _h(JUL, 8615.57, JULd, 5)],
  117: [_h(OCT, 6931.22, OCTd, 2), _h(JUN, 6235.29, JUNd, 1), _h(JUL, 6334.98, JULd, 1)],
  201: [_h(OCT, 29111.11, OCTd, 11), _h(JUL, 26606.91, JULd, 11)],
  202: [_h(OCT, 24675.13, OCTd, 5), _h(JUL, 22552.52, JULd, 5)],
  301: [_h(OCT, 6475.47, OCTd, 1), _h(JUN, 5792.08, JUNd, 1), _h(JUL, 5799.04, JULd, 1)],
  401: [_h(OCT, 5045.93, OCTd, 10), _h(JUN, 4539.29, JUNd, 10), _h(JUL, 4611.86, JULd, 10)],
  402: [_h(OCT, 809.43, OCTd, 5), _h(JUN, 724.01, JUNd, 5), _h(JUL, 724.88, JULd, 5)],
  ...
  119: [_h(SEP, 233.13, SEPd, 10), _h(JUN, 209.51, JUNd, 23), _h(JUN18, 209.36, JUN18d, 13), _h(JUL, 212.86, JULd, 23)],
  // ── Nuevos accesorios DCAM 16-jun-2026 ──
  120: [_h(JUN, 467.70, JUNd, 18), _h(JUL, 475.17, JULd, 14)],
  121: [_h(JUN, 467.70, JUNd, 31), _h(JUL, 475.17, JULd, 29)],
  122: [_h(JUN, 467.70, JUNd, 44), _h(JUL, 475.17, JULd, 42)],
  123: [_h(JUN, 577.82, JUNd, 30), _h(JUL, 578.51, JULd, 30)],
  124: [_h(JUN, 530.09, JUNd, 2), _h(JUN18, 529.07, JUN18d, 10), _h(JUL, 530.73, JULd, 2)],
  125: [_h(JUN, 623.53, JUNd, 29), _h(JUN18, 618.96, JUN18d, 1), _h(JUL, 633.50, JULd, 27)],
  126: [_h(JUN, 977.69, JUNd, 20), _h(JUL, 993.32, JULd, 20)],
  127: [_h(JUN, 977.69, JUNd, 6), _h(JUL, 993.32, JULd, 6)],
  128: [_h(JUN18, 619.95, JUN18d, 16)],
  129: [_h(JUN18, 521.02, JUN18d, 12)],
  130: [_h(JUN18, 623.11, JUN18d, 13), _h(JUL, 633.50, JULd, 29)],
  131: [_h(JUN18, 1121.59, JUN18d, 16), _h(JUL, 1140.30, JULd, 37)],
};
