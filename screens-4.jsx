  ...
  return (
    <div className={fxClass} style={{
      ...
      <div style={{ padding: '14px 20px 16px', textAlign: 'center' }}>
        <h3 onClick={go} style={{
          margin: 0, cursor: 'pointer', fontFamily: 'Archivo, sans-serif', fontWeight: 700, fontSize: 20,
        ...
        {p.features.map((f) => (
          <li key={f} style={{ display: 'flex', gap: 9, alignItems: 'flex-start' }}>
            <span style={{
              ...
              background: 'rgba(221,213,196,0.16)', color: PALETTE.amber,
    ...
    <div style={{ padding: `8px 0 6px`, maxWidth: 1280, marginLeft: 'auto', marginRight: 'auto', width: '100%', boxSizing: 'border-box' }}>
      ...
      <style>{`
        ...
        @keyframes traumaGlowAmber {
          0%,100% { box-shadow: 0 0 0 1px rgba(221,213,196,0.32), 0 0 16px 2px rgba(221,213,196,0.22), 0 4px 16px rgba(0,0,0,0.28); }
          50%     { box-shadow: 0 0 0 1px rgba(221,213,196,0.82), 0 0 34px 8px rgba(221,213,196,0.55), 0 0 56px 16px rgba(245,170,20,0.26), 0 4px 16px rgba(0,0,0,0.28); }
        }
