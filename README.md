...
servidas como **450 páginas HTML prerenderizadas** para que los buscadores y los
bots de IA —que no ejecutan JavaScript— vean el contenido real. El sitemap declara
**446 URLs**, 408 de ellas con la fecha real de su inventario (la última, 2026-09-18).
