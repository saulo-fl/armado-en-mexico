...
(function(){
  ...
  const DEFAULT_PAGES = {
    ...
    faq: [
      ...
      { q: '¿Puedo comprar un arma en cualquier tienda?', a: 'No. En México un arma de fuego solo puede adquirirse por los canales oficiales: la DCAM (Dirección de Comercialización de Armamento y Municiones de la SEDENA), en Naucalpan, Estado de México (Av. Industria Militar 1111, Col. Lomas de Tecamachalco), y la OTCA, en Monterrey, N.L. Son instituciones distintas: la DCAM no tiene sede en Monterrey.' },
      { q: '¿Cuánto cuesta tramitar la licencia?', a: 'Las cuotas las fija la Ley Federal de Derechos y se actualizan cada 1 de enero. En 2026, el permiso extraordinario para la adquisición de armas de fuego, cartuchos y accesorios (DEFENSA-02-040) cuesta $490 MXN, y el registro de cada arma (DEFENSA-02-062), $201 MXN. Se pagan en el banco con la hoja de ayuda e5cinco y no incluyen el precio del arma.' },
      ...
      { q: '¿Cuántas armas puedo tener registradas?', a: 'Según el Registro Federal de Armas, puedes poseer un arma corta para la protección de tu domicilio; inscrito en un club de caza y tiro, puedes poseer 9 armas largas de características deportivas y un arma corta calibre .22. Coleccionistas registrados pueden tener más con licencia especial.' },
      { q: '¿Las balas se compran igual?', a: 'En la DCAM, los requisitos dependen del cartucho. Escopeta (12, 16 y 20 GA y .410): la hoja de manifestación de registro del arma y una identificación oficial vigente. Fuego anular (.22 LR y .22 Short): lo mismo, más el Volante de Adquisición de Cartuchos del mes, expedido por tu club, y la credencial vigente del club. Alto poder y fuego central (por ejemplo .223, 30-06, .308, .380 y .38 Special): el permiso extraordinario de adquisición vigente y una identificación oficial vigente. Los cartuchos de uso exclusivo de las Fuerzas Armadas (calibre superior a 9 mm) solo están previstos para personal militar. Existe un límite anual de adquisición por calibre.' },
