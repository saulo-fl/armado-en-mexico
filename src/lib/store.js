...
(function(){
  ...
  const DEFAULT_PAGES = {
    ...
    faq: [
      ...
      { q: '¿Qué calibres puedo tener como civil?', a: 'Para uso doméstico: pistolas .380 ACP máximo, revólveres .38 Special máximo, escopetas hasta calibre 12, rifles deportivos en calibres permitidos. La Ley Federal de Armas de Fuego y Explosivos reserva las pistolas 9 mm Parabellum al uso exclusivo de la Fuerza Armada Permanente (art. 11); para socios de clubes de tiro y cacería, las pistolas que menciona son las de calibre .22, las de .38 con fines de tiro olímpico o de competencia y las de .380 (art. 10).' },
