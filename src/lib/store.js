...
(function(){
  ...
  const DEFAULT_PAGES = {
    ...
    faq: [
      ...
      { q: '¿Cuántas armas puedo tener registradas?', a: 'Depende de la modalidad en que se registra cada arma. En protección de domicilio, que no exige pertenecer a un club, la Secretaría de la Defensa Nacional autoriza un arma corta: una pistola de calibre no superior al .380 o un revólver de calibre no superior al .38 Especial. A quien practica tiro y cacería inscrito en un club o asociación acreditado ante la Secretaría, la Ley Federal de Armas de Fuego y Explosivos le permite poseer hasta 10 armas de las que enumera su artículo 10. Por actividad, el permiso extraordinario para transportarlas (DEFENSA-02-045) autoriza 10 armas en tiro y en competencia, y nueve armas largas y una corta calibre .22 en cacería. Los ejidatarios, comuneros y jornaleros del campo pueden poseer un rifle .22 o una escopeta y, además, un arma corta en su domicilio. Coleccionistas registrados pueden tener más con el permiso para coleccionista o museo de armas de fuego (DEFENSA-02-032).' },
