            ...
            {existencias &&
              <div style={{ marginTop: 11, paddingTop: 11, borderTop: `1px solid ${P.border}` }}>
                <div style={{ display: 'flex', alignItems: 'baseline', gap: 8, flexWrap: 'wrap' }}>
                  ...
                  <span style={{ fontFamily: 'Courier Prime, monospace', fontSize: 14.5, color: P.text, letterSpacing: '0.06em' }}>disponibles en {curSigla}</span>
                </div>
                <div style={{ fontFamily: 'Courier Prime, monospace', fontSize: 12.5, color: P.textDim, marginTop: 5, lineHeight: 1.55 }}>
                  ...
                  {currentManual && currentManual.url ? (
                    ...
                    <span style={{ color: P.textMuted }}>{currentManual ? currentManual.nombre : 'inventario oficial DCAM'}</span>
                  )}
                  {currentManual ? ', publicado el ' + accFmtDate(currentManual.fecha) : ', publicado el ' + accFmtDate(existencias.date)}.
                </div>
